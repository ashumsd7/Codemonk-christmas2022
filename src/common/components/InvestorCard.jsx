...
function InvestorCard({ data, isConnected = false, isRequestSent = false }) {
  ...
  return (
    <>
      <RhCard
        className="my-4 card-hover cursor-pointer  hover:drop-shadow-lg"
        onClick={() => {
          ...
          <div>
            ...
            <div className="flex gap-6 flex-wrap">
              ...
              <div className="flex flex-col flex-1 gap-2  justify-center">
                ...
                <div>
                  {data?.investment_focus_area?.map((area) => {
                    return (
                      <RhChip
                        key={area?.name}
                ...
                {isLoggedIn() && (
                  <>
                    ...
                    {isRequestSent && !isConnected && (
                      <RhTooltip
                        position="bottom"
                        title="Request sent! waiting to be accepted by the investor."
                      >
                        <div className="flex items-center">
                          <RhIcon
